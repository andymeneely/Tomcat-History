...
hist(fixchurn$JavaChurn[fixchurn$JavaChurn!=0], breaks=20, col="red", main="Histogram of Java Code Fix Churn", freq=TRUE, xlab="Lines of Java Code, Added+Deleted", labels=TRUE, axes=FALSE) 
axis(2) 
